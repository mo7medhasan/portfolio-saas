    ...
    <section id="skills" className="py-[var(--section-padding-y,6rem)] bg-[var(--color-surface,#f8f8f8)]">
      <div className="mx-auto max-w-[var(--container-max-width,1200px)] px-6">
        ...
        <div className="flex flex-wrap gap-3 justify-center">
          {c.items.map((skill) => (
            <span key={skill.id} className="px-4 py-2 text-sm font-medium rounded-[var(--radius-full,9999px)] border border-[var(--color-border,#e5e5e5)] transition-all hover:border-[var(--color-primary,#6C63FF)] hover:text-[var(--color-primary,#6C63FF)] cursor-default"
